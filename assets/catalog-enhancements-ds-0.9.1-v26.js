(() => {
  ...
  const text = {
    th: {
      ...
      visualFocus: {
        ...
        "dataset-flood-recurrent": {
          label: "ผักไห่ · บริบทน้ำท่วมหลายปี",
          intro: "เห็นขอบเขตน้ำท่วมรายปีและการเกิดซ้ำในอำเภอผักไห่ โดยตรวจช่วงปีจากแหล่งข้อมูลก่อนใช้",
        ...
        "dataset-flood-forecast-flash-flood-risk": {
          label: "สัญญาณน้ำท่วมฉับพลัน · ต้องยืนยันช่วงคาดการณ์",
          intro: "ใช้รายการนี้เพื่อระบุพื้นที่ ช่วงคาดการณ์ และเวลาออกรันที่ต้องตรวจจากแหล่งทางการ",
    ...
    en: {
      ...
      visualFocus: {
        ...
        "dataset-flood-recurrent": {
          label: "Phak Hai · multi-year flood context",
          intro: "See annual flood extent and recurrence in Phak Hai, checking the source period before use",
        ...
        "dataset-flood-forecast-flash-flood-risk": {
          label: "Flash-flood signal · forecast horizon unverified",
          intro: "Use this record to identify the area, forecast horizon and run time to verify at the named provider source",
  ...
  function enhanceCard(card) {
    ...
    if (!record || card.dataset.sourceReviewVersion === "2026-09-04-r5") return;
    ...
    card.dataset.sourceReviewVersion = "2026-09-04-r5";
