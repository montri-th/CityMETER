...
**Web output:** `media/reel/citymeter-proof-v3.mp4`

**Exhibition output:** `media/reel/citymeter-proof-v3-exhibition.mp4`

**Poster:** `media/reel/citymeter-proof-v3-poster.webp`
...
| 3.15–6.30 | `02-building.webp` — Suan Plu 3D view | Complete chapter 1 by moving from population context into a dense, legible 3D building example with GFA, building count, height and floors | Open Buildings is not a building register and does not prove a complete verified footprint for every structure. |
...
- Every frame comes from a settled, real CityMETER screen in dark theme. Population was recaptured after the layer had fully rendered so no missing rectangular geometry remains. The Building chapter uses the owner-supplied Suan Plu screenshot with the 3D layer, selected-building detail and summary panel visibly complete.
